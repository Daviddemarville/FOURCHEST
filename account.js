...
const lastresto = [
	{
		...
		description:
			"Généreusement servis, les plats sont fait-maison par une équipe de passionnés. Retrouvez les plats réconfortants de la cuisine alsacienne, parsemés de touches gourmandes, signatures du Chef : de la bouchée à la reine, spécialité de la maison, à la Forêt Noire, sans oublier l’incontournable choucroute.",
		lastread: "1 days ago",
		link: "#",
	},
	{
...
const orders = [
	{
		...
		items: [
			...
			{
				name: "Jarret de porc braisé à la bière, pommes sautées, salade verte",
				price: "21.90€",
			},
...

	{
		...
		items: [
			...
			{
				name: "Champignons farcis au escargots de Rémy Koehl ",
				price: "11.70€",
			},
			{
				name: "Saucisson du moment (Bergkäs au munster... selon arrivage) de la boucherie Degert, Pickles",
				price: "9.70€",
			},
			{
				name: "Sylvaner Vieille Vigne Dom Materne Haegelin bouteille",
				price: "34.00€",
			},
			{
				name: "Kougelhopf glacé aux raisins macérés au marc de Gewurz de la maison Alba",
				price: "8.00€",
			},
			{
				name: "Kougelhopf façon pain perdu, fruit du moment et boule de glace",
				price: "9.00€",
			},
...
document
	.getElementById("edit-personal-info-btn")
...
document
	.getElementById("edit-billing-address-btn")
	.addEventListener("click", () => {
		const billingAddress = prompt(
			"Entrez votre nouvelle adresse de facturation:",
			"6, rue des Grand hommes, 67000 Strasbourg",
		);
		if (billingAddress) {
...
// Modification de l'adresse de livraison
document
	.getElementById("edit-shipping-address-btn")
	.addEventListener("click", () => {
		const newShippingAddress = prompt(
			"Entrez votre nouvelle adresse de livraison:",
		);
